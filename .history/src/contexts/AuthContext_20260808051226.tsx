...
import { getResubmissionFieldsForPreset, getResubmissionPresetKey, getResubmissionSuggestedReason, getResubmissionSuggestedReasonForPreset, inferResubmissionFields, inferResubmissionPreset, type ResubmissionFieldKey, type ResubmissionPresetKey } from "../utils/reviewDecision";
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const verifyUserInDb = async (
    ...
    const resubmissionPreset = isResubmissionRequested ? (decision?.preset || inferResubmissionPreset(notes)) : "custom";
