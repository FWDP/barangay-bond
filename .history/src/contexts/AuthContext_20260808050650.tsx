...
import { getResubmissionSuggestedReason, inferResubmissionFields, type ResubmissionFieldKey } from "../utils/reviewDecision";
...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
    ...
    try {
      ...
      try {
        ...
        const newProfile: UserProfile = {
          ...
          reviewOutcome: initialVerStatus === "auto_rejected" ? "resubmission_required" : "approved",
          resubmissionFields: [],
          resubmissionReason: "",
          resubmissionSuggestedReason: "",
          lastDecisionBy: null,
  ...
  const executeAIVerification = async (
    ...
    try {
      ...
      if (hasExactDuplicate) {
        ...
        updatedProfile.resubmissionFields = inferResubmissionFields(updatedProfile.autoRejectReason, ["idNumber"]);
        updatedProfile.resubmissionReason = updatedProfile.autoRejectReason;
        updatedProfile.resubmissionSuggestedReason = getResubmissionSuggestedReason(updatedProfile.resubmissionFields);
      } else {
        ...
        try {
          ...
          if (isAutoReject) {
            ...
            updatedProfile.reviewOutcome = "resubmission_required";
            updatedProfile.resubmissionFields = inferResubmissionFields(updatedProfile.autoRejectReason, ["idPhotoUrl"]);
            if (updatedProfile.autoRejectReason.toLowerCase().includes("selfie")) {
  ...
  const verifyUserInDb = async (
    ...
    const resubmissionFields = isResubmissionRequested ? (decision?.resubmissionFields || inferResubmissionFields(notes)) : [];
    const suggestedReason = isResubmissionRequested ? (decision?.suggestedReason || getResubmissionSuggestedReason(resubmissionFields)) : "";
