...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const adminOverrideApprove = async (targetUid: string, note?: string) => {
    ...
    if (profile.role === "barangay_admin") {
      const targetBgy = targetProfile.requestedBarangayId || targetProfile.barangayId;
      if (targetBgy && profile.barangayId && targetBgy !== profile.barangayId) {
        throw new Error("Unauthorized: target user not in your barangay custody");
      }
    }
