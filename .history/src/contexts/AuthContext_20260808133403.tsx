...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({
  ...
  const adminOverrideApprove = async (targetUid: string, note?: string) => {
    ...
    // If admin is barangay_admin, ensure same barangay custody
    if (profile.role === "barangay_admin") {
      const targetBgyRaw = targetProfile.requestedBarangayId || targetProfile.barangayId || "";
      const adminBgyRaw = profile.barangayId || "";
      const normalizeBgy = (s: any) => (s || "").toString().trim().toLowerCase();
      ...
      if (targetBgy && adminBgy && targetBgy !== adminBgy) {
