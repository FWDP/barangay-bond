  ...
  const setDoc = async (ref: any, data: any, options?: any) => {
    ...
    try {
      if (options) {
        ...
        // duplicate_reports gets created during AI verification for a resident owner.
        // A lookup-before-write probe on an absent duplicate doc can trip the get rule on
        // a document that is not yet readable by rule contract, so write directly.
