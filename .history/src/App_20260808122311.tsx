...
const AppController: React.FC = () => {
  ...
  // If already logged in and not in a restricted review state, send to dashboard.
  if (
    user &&
    viewState === "landing" &&
    profile &&
  ...
  // If the signed in user is in a locked/inactive resubmission state, keep them in auth so they can resume application.
  if (
    user &&
    viewState === "landing" &&
    profile &&
    (profile.status === "inactive" || profile.verificationStatus === "auto_rejected")
  ) {
    setViewState("auth");
  }
