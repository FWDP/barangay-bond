...
const AppController: React.FC = () => {
  ...
  // Redirect authenticated users into the dashboard shell unless they are still onboarding, pending email verification, or inactive.
  if (user && viewState === "auth" && profile && !["pending_email_verification", "onboarding", "inactive"].includes(profile.status)) {
    setViewState("dashboard");
  }
