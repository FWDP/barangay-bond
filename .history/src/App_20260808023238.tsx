...
const AppController: React.FC = () => {
  ...
  const { loading, user, profile, signOut, executeAIVerification, authError } = useAuth();
  ...
  // If there is an auth error from an auto sign-out, show the auth page immediately
  if (authError && viewState !== "auth") {
    setViewState("auth");
  }
