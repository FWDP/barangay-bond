...
const AppController: React.FC = () => {
  ...
  // Redirect authenticated users into the dashboard shell unless they are still onboarding, pending email verification, inactive, pending review, or auto-rejected.
  if (
    user &&
    viewState === "auth" &&
    profile &&
    !["pending_email_verification", "onboarding", "inactive", "pending"].includes(profile.status) &&
    profile.verificationStatus !== "auto_rejected"
  ) {
    setViewState("dashboard");
  }
